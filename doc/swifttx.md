...
This mechanism has been integrated into Bitcore-Node-TaurusMaster which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/taurusmaster-crypto/insight-api-taurusmaster#web-socket-api](https://github.com/taurusmaster-crypto/insight-api-taurusmaster#web-socket-api) 
* API: [https://github.com/taurusmaster-crypto/insight-api-taurusmaster#swifttx-transactions](https://github.com/taurusmaster-crypto/insight-api-taurusmaster#swifttx-transactions) 
...
By default, the TaurusMaster Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TaurusMaster Core daemon:
