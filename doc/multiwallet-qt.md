...
In order to support loading of multiple wallets in taurusmaster-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is taurusmaster.cpp.
...
Changes to taurusmaster.cpp
----------------------
taurusmaster.cpp is the entry point into taurusmaster-qt, and as such, will require some minor modifications to provide hooks for
